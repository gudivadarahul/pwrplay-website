        ...
        <div className="pt-32 px-6 min-h-screen bg-black text-white">
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-8">
                    ...
                    <ul className="list-disc list-inside opacity-80 text-lg ml-4">
                    ...
                    <h2 className="text-3xl font-semibold">SUMMARY OF KEY POINTS</h2>
                    <p className="opacity-80 text-lg">
                        This summary provides key points from our Privacy Notice, but you can find out more details about any of these topics by clicking the link following each key point or by using our table of contents below to find the section you are looking for.
                    </p>

                    <h2 className="text-3xl font-semibold">1. WHAT INFORMATION DO WE COLLECT?</h2>
                    ...
                    <p className="opacity-80 text-lg">The information we collect includes:</p>
                    <ul className="list-disc list-inside opacity-80 text-lg ml-4">
                    ...
                    <h2 className="text-3xl font-semibold">3. Third-Party Services</h2>
                    <p className="opacity-80 text-lg">
                        We may use third-party services like Google Analytics to track website traffic.
                    </p>

                    <h2 className="text-3xl font-semibold">4. Security Measures</h2>
                    <p className="opacity-80 text-lg">
                        We implement security measures to protect your data, but we cannot guarantee complete security.
                    </p>

                    <h2 className="text-3xl font-semibold">2. HOW DO WE PROCESS YOUR INFORMATION?</h2>
                    <p className="opacity-80 text-lg">
                    ...
                    <h2 className="text-3xl font-semibold">3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR INFORMATION?</h2>
                    <p className="opacity-80 text-lg">
                    ...
                    <h2 className="text-3xl font-semibold">4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h2>
                    <p className="opacity-80 text-lg">
                    ...
                    <p className="opacity-80 text-lg">The categories of third parties we may share personal information with are as follows:</p>
                    <ul className="list-disc list-inside opacity-80 text-lg ml-4">
                    ...
                    <p className="opacity-80 text-lg">We also may need to share your personal information in the following situations:</p>
                    <ul className="list-disc list-inside opacity-80 text-lg ml-4">
                        <li>Business Transfers. We may share or transfer your information in connection with, or during negotiations of, any merger, sale of company assets, financing, or acquisition of all or a portion of our business to another company.</li>
                    </ul>

                    <h2 className="text-3xl font-semibold">5. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h2>
                    <p className="opacity-80 text-lg">
                    ...
                    <h2 className="text-3xl font-semibold">6. IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?</h2>
                    <p className="opacity-80 text-lg">
                    ...
                    <h2 className="text-3xl font-semibold">7. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
                    <p className="opacity-80 text-lg">
                    ...
                    <h2 className="text-3xl font-semibold">8. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
                    <p className="opacity-80 text-lg">
                    ...
                    <h2 className="text-3xl font-semibold">9. DO WE COLLECT INFORMATION FROM MINORS?</h2>
                    <p className="opacity-80 text-lg">
                    ...
                    <h2 className="text-3xl font-semibold">10. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
                    <p className="opacity-80 text-lg">
                        In Short: Depending on your state of residence in the US or in some regions, such as the European Economic Area (EEA), United Kingdom (UK), Switzerland, and Canada, you have rights that allow you greater access to and control over your personal information. You may review, change, or terminate your account at any time, depending on your country, province, or state of residence.
                    </p>

                    <h2 className="text-3xl font-semibold">11. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
                    <p className="opacity-80 text-lg">
                    ...
                    <h2 className="text-3xl font-semibold">12. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
                    <p className="opacity-80 text-lg">
                    ...
                    <p className="opacity-80 text-lg">We collect and share your personal information through:</p>
                    <ul className="list-disc list-inside opacity-80 text-lg ml-4">
                    ...
                    <h2 className="text-3xl font-semibold">13. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
                    <p className="opacity-80 text-lg">
                    ...
                    <h2 className="text-3xl font-semibold">14. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>
                    <p className="opacity-80 text-lg">
                    ...
                    <h2 className="text-3xl font-semibold">15. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
                    <p className="opacity-80 text-lg">
