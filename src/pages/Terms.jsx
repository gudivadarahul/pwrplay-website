        ...
        <div className="pt-32 px-6 min-h-screen bg-black text-white">
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-8">
                    <h2 className="text-3xl font-semibold">AGREEMENT TO OUR LEGAL TERMS</h2>
                    ...
                    <h2 className="text-3xl font-semibold">1. OUR SERVICES</h2>
                    <p className="opacity-80 text-lg">
                    ...
                    <h2 className="text-3xl font-semibold">2. INTELLECTUAL PROPERTY RIGHTS</h2>
                    ...
                    <h2 className="text-3xl font-semibold">3. USER REPRESENTATIONS</h2>
                    <p className="opacity-80 text-lg">
                    ...
                    <h2 className="text-3xl font-semibold">4. PROHIBITED ACTIVITIES</h2>
                    <p className="opacity-80 text-lg">
                    ...
                    <h2 className="text-3xl font-semibold">5. USER GENERATED CONTRIBUTIONS</h2>
                    <p className="opacity-80 text-lg">
                    ...
                    <h2 className="text-3xl font-semibold">6. CONTRIBUTION LICENSE</h2>
                    <p className="opacity-80 text-lg">
                    ...
                    <h2 className="text-3xl font-semibold">7. THIRD-PARTY WEBSITES AND CONTENT</h2>
                    <p className="opacity-80 text-lg">
                    ...
                    <h2 className="text-3xl font-semibold">8. SERVICES MANAGEMENT</h2>
                    <p className="opacity-80 text-lg">
                    ...
                    <h2 className="text-3xl font-semibold">9. PRIVACY POLICY</h2>
                    <p className="opacity-80 text-lg">
                    ...
                    <h2 className="text-3xl font-semibold">10. TERM AND TERMINATION</h2>
                    <p className="opacity-80 text-lg">
                    ...
                    <h2 className="text-3xl font-semibold">11. MODIFICATIONS AND INTERRUPTIONS</h2>
                    <p className="opacity-80 text-lg">
                    ...
                    <h2 className="text-3xl font-semibold">12. GOVERNING LAW</h2>
                    <p className="opacity-80 text-lg">
                    ...
                    <h2 className="text-3xl font-semibold">13. DISPUTE RESOLUTION</h2>
                    <p className="opacity-80 text-lg">
                    ...
                    <h2 className="text-3xl font-semibold">14. CORRECTIONS</h2>
                    <p className="opacity-80 text-lg">
                        There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.
                    </p>

                    <h2 className="text-3xl font-semibold">15. DISCLAIMER</h2>
                    <p className="opacity-80 text-lg">
                    ...
                    <h2 className="text-3xl font-semibold">16. LIMITATIONS OF LIABILITY</h2>
                    <p className="opacity-80 text-lg">
                        IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY DIRECT, INDIRECT, CONSEQUENTIAL, EXEMPLARY, INCIDENTAL, SPECIAL, OR PUNITIVE DAMAGES, INCLUDING LOST PROFIT, LOST REVENUE, LOSS OF DATA, OR OTHER DAMAGES ARISING FROM YOUR USE OF THE SERVICES, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
                    </p>

                    <h2 className="text-3xl font-semibold">17. INDEMNIFICATION</h2>
                    <p className="opacity-80 text-lg">
                    ...
                    <h2 className="text-3xl font-semibold">18. USER DATA</h2>
                    <p className="opacity-80 text-lg">
                        We will maintain certain data that you transmit to the Services for the purpose of managing the performance of the Services, as well as data relating to your use of the Services. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Services. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.
                    </p>

                    <h2 className="text-3xl font-semibold">19. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
                    <p className="opacity-80 text-lg">
                    ...
                    <h2 className="text-3xl font-semibold">20. CALIFORNIA USERS AND RESIDENTS</h2>
                    <p className="opacity-80 text-lg">
                        If any complaint with us is not satisfactorily resolved, you can contact the Complaint Assistance Unit of the Division of Consumer Services of the California Department of Consumer Affairs in writing at 1625 North Market Blvd., Suite N 112, Sacramento, California 95834 or by telephone at (800) 952-5210 or (916) 445-1254.
                    </p>

                    <h2 className="text-3xl font-semibold">21. MISCELLANEOUS</h2>
                    <p className="opacity-80 text-lg">
                    ...
                    <h2 className="text-3xl font-semibold">22. CONTACT US</h2>
                    <p className="opacity-80 text-lg">
